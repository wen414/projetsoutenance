<!-- filepath: /Users/obeyowen/GestionStagiaires/resources/views/C_SRHDS/dashboard.blade.php -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Dashboard C/SRHDS</title>
...
<body class="bg-gray-100 text-gray-800">
    ...
    <nav class="bg-white shadow-md fixed w-full z-10">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <span class="text-gray-600">Bonjour, C/SRHDS</span>
            </div>
        </div>
    </nav>
    ...
    <div class="container mx-auto py-20">
        <h1 class="text-3xl font-bold mb-6 animate__animated animate__fadeInDown">Bienvenue, C/SRHDS</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow duration-300 animate__animated animate__zoomIn">
                ...
                <a href="{{ route('c_srhds.demandes') }}" class="text-blue-600 hover:underline mt-4 inline-block">Voir plus</a>
            </div>
            <!-- Card 2 -->
            ...
            <div class="bg-white shadow-lg rounded-lg p-6 hover:shadow-xl transition-shadow duration-300 animate__animated animate__zoomIn animate__delay-2s">
                ...
                <p class="text-gray-600">Consultez et traitez les demandes de stage assignées.</p>
                <a href="{{ route('c_srhds.demandes') }}" class="text-blue-600 hover:underline mt-4 inline-block">Voir plus</a>
            </div>
            <!-- Card 4 -->
