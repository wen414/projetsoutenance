<!-- filepath: /Users/obeyowen/GestionStagiaires/resources/views/chef_service/dashboard.blade.php -->
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Dashboard Chef Service</title>
...
<body class="bg-gray-100 text-gray-800">
    ...
    <nav class="bg-white shadow-md fixed w-full z-10">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <span class="text-gray-600">Bonjour, Chef Service</span>
            </div>
        </div>
    </nav>
    ...
    <div class="container mx-auto py-20">
        <h1 class="text-3xl font-bold mb-6 animate__animated animate__fadeInDown">Bienvenue, Chef Service</h1>
